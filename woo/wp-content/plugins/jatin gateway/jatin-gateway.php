<?php
/**
*Plugin Name: Jatin Gateway
*Description: A simple payment gateway for users to pay for their orders.Receive credit card or PayPal payments using Paypal Powered by Braintree. A server with cURL, SSL support, and a valid SSL certificate is required (for security reasons) for this gateway to function. Requires PHP 5.4+
*Version: 1.0
        ...
        public function init_form_fields() {
            ...
            $this->form_fields = array(
                ...
                'order_status' => array(
                    ...
                    'description' => __( 'Choose what status you wish to choose after checkout.', $this->domain ),
