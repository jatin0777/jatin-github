...
if ( ! class_exists( 'Euphony_Customizer_Reset' ) ) {
	/**
	 * Adds Reset button to customizer
	 */
	final class Euphony_Customizer_Reset {
		/**
		 * @var Euphony_Customizer_Reset
		 */
		...
		public function customize_controls_print_scripts() {
			wp_enqueue_script( 'euphony-customizer-reset', trailingslashit( esc_url ( get_template_directory_uri() ) ) . 'assets/js/customizer-reset.min.js', array( 'jquery' ), '20190207' );
			
			wp_localize_script( 'euphony-customizer-reset', 'euphonyCustomizerReset', array(
				'reset'          => esc_html__( 'Reset', 'euphony' ),
