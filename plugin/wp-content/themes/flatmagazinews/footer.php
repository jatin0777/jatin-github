	...
	<div class="content-wrap">
		...
		<div class="site-info">
			...
			<span class="footer-info-right">
				<?php echo __(' | WordPress Theme by', 'flatmagazinews') ?> <a href="<?php echo esc_url('https://superbthemes.com/', 'flatmagazinews'); ?>" rel="designer"><?php echo __('Superbthemes.com', 'flatmagazinews') ?></a>
			</span>
