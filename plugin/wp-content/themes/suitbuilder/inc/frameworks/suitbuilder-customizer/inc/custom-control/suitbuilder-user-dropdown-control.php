<?php
if ( class_exists( 'WP_Customize_Control' ) && ! class_exists( 'Suitbuilder_Customizer_User_Dropdown_Control' ) ){
    /**
     * Custom Control for user dropdown
     * @since 1.0.0
     *
     */
    class Suitbuilder_Customizer_User_Dropdown_Control extends WP_Customize_Control {
