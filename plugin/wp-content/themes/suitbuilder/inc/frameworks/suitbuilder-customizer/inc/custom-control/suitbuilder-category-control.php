<?php
if ( class_exists( 'WP_Customize_Control' ) && !class_exists( 'Suitbuilder_Customizer_Category_Dropdown_Control' )){
    /**
     * Custom Control for category dropdown
     * @since 0.0.1
     *
     */
    class Suitbuilder_Customizer_Category_Dropdown_Control extends WP_Customize_Control {
        ...
        public function render_content() {
            $name = 'suitbuilder_customizer_dropdown_categories_' . $this->id;
