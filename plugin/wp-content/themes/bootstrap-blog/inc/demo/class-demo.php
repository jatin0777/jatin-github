 ...
 * Demo class
 *
 * @package Bootstrap_Blog
 */

if ( ! class_exists( 'Bootstrap_Blog_Demo' ) ) {
	 ...
	 * @since 1.0.0
	 */
	class Bootstrap_Blog_Demo {

		/**
		 * Singleton instance of Bootstrap_Blog_Demo.
		 *
		 * @var Bootstrap_Blog_Demo $instance Bootstrap_Blog_Demo instance.
		 */
		...
		/**
		 * Main Bootstrap_Blog_Demo instance.
		 *
		 * @since 1.0.0
		 *
		...
		public static function init( $config ) {
			if ( ! isset( self::$instance ) && ! ( self::$instance instanceof Bootstrap_Blog_Demo ) ) {
				self::$instance = new Bootstrap_Blog_Demo();
