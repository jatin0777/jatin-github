...
if ( ! class_exists( 'Bootstrap_Blog_Slider_Control' ) ) {

	/**
	 * Slider control (range).
	 */
	class Bootstrap_Blog_Slider_Control extends Wp_Customize_Control {
        ...
        public function enqueue() {            
            wp_enqueue_style( 'bootstrap-blog-slider', get_template_directory_uri() . '/inc/custom-controls/slider/slider.css', null );
            wp_enqueue_script( 'bootstrap-blog-slider', get_template_directory_uri() . '/inc/custom-controls/slider/slider.js', array( 'jquery' ), false, true ); //for slider                
        }
