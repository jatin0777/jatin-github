  ...
  <div id="owl-slider" class="owl-carousel"> 
    <?php while ( $query->have_posts() ) : $query->the_post(); ?>
        <div class="item">
          ...
          <?php $image = wp_get_attachment_image_src( get_post_thumbnail_id( $post->ID ), 'bootstrap_blog_slider' ); ?>
              ...
              <div class="banner-news-caption">
                ...
                <?php if( in_array( 'readmore', $post_details ) ) : ?>
                  <a href="<?php echo esc_url( get_the_permalink( $post->ID ) ); ?>" class="readmore"><?php esc_attr_e( 'Read More', 'bootstrap-blog' ); ?></a>
                <?php endif; ?>
              </div> 
          </div>
        </div>
