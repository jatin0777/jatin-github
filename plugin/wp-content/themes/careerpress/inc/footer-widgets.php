...
class Careerpress_Footer_Widgets{
	 ...
	 * @var int
	 */
	protected $theme_prefix = 'careerpress';
	...
	function footer_widgets_init() {
		...
		for ( $i = 1; $i <= $this->max_widgets; $i++ ) {
			register_sidebar( array(
				'name'          => sprintf( __( 'Footer Widget %d', 'careerpress' ), $i ),
...
// Initialize.
$careerpress_footer_widgets = new Careerpress_Footer_Widgets();
